...
\begin{enumerate}
    ...
    \item \textbf{Table filling} As shown in Figure~\ref{fig:alloc:2}, the algorithm traverses the entries from \textit{b1} to \textit{h7} in the row-major manner, 
        ...
        After the traversal, the score of bottom-right corner, \textit{h7}, represents the optimized cycle counts to accomplish two operation sequences.
...
\\\indent
On the other hand, a left-subtree has a higher priority than its sibling in the conventional postorder-traversal, 
