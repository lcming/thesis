...
\begin{figure}[!ht]
    \begin{center}
        \subfigure[Stage 1: table filling]
        {
            \label{fig:alloc}
            \includegraphics[width=0.45\textwidth]{figs/alloc.eps}
        }
        \hfill
        \subfigure[Stage 2: backtracking]
        {
            \label{fig:alloc2}
            \includegraphics[width=0.45\textwidth]{figs/alloc2.eps}
        }
    \end{center}
