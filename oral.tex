    ...
    \begin{frame}{Contribution}
        \begin{itemize}
            ...
            \begin{frame}{Advanced Design Considerations}
                \centering
                {
                    \animategraphics[loop,controls,width=\linewidth]{12}{./gif/tree-}{0}{10}
                }
                \pause
                \begin{itemize}
