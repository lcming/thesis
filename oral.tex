    ...
    \begin{frame}{Contribution}
        \begin{itemize}
            ...
            \begin{frame}{Advanced Design Considerations}
                \centering
                {
                    \animategraphics[loop,controls,width=\linewidth]{36}{./gif/tree-}{0}{1}
                }
                \pause
                \begin{itemize}
...
%            \end{frame}
            ...
            \begin{frame}{Integrating DeAr with HSA (1/3)}
                \begin{itemize}
                    \item <2-> {Multi-core DeAr with shared I-cache~\footfullcite{kelly2004shared} --- fitting HSA SPMD and \textbf{avoiding program duplication}}
                    \item <3-> {SC-based direct memory access (DMA) engine~\footfullcite{sc}
                            \begin{itemize}
            ...
            \begin{frame}{Operations per Cycle}
                ...
                \begin{itemize}
                    ...
                    \item <4->{DeAr has only 1.11\% and 4.26\% loss against VLIW, 
                                and outperforms Composite-ALU by \textbf{75.2\%--12.7\%} and \textbf{21.7\%--16.3\%}}
                \end{itemize}
            ...
            \begin{frame}{Register File Access Rate}
                ...
                \begin{itemize}
                    ...
                    \item <4->{DeAr saves either \textbf{31\%} and \textbf{27\%} RF access against VLIW,
                                or saves \textbf{30.3\%--10.4\%} and \textbf{16.1\%--11.0\%} against Composite-ALU}
                \end{itemize}
            \end{frame}
            ...
            \begin{frame}{Area}
                ...
                \end{figure}
                \begin{itemize}
                    \item <2->{DeAr outperforms either VLIW by \textbf{35.4\%--21.1\%} and \textbf{35.2\%--21.6\%}, 
                                or Composite-ALU by \textbf{21.2\%--5.3\%} and \textbf{33.5\%--4.7\%}}
                    \item <3->{\textbf{Long critical path} (Composite-ALU) and \textbf{low OPC} (scalar) lead to \textbf{sharp growth} and \textbf{synthesis fail}}
                \end{itemize}
            \end{frame}
            ...
            \begin{frame}{Power Dissipation}
                ...
                \begin{itemize}
                    \item <2->{DeAr outperforms either VLIW by \textbf{35.4\%--21.1\%} and \textbf{35.2\%--21.6\%}, 
                            or Composite-ALU by \textbf{21.2\%--5.3\%} and \textbf{33.5\%--4.7\%}}
                    \item <3->{Linear growth regardless of design indicates the \textbf{domination of dynamic power}}
                \end{itemize}
            \end{frame}
