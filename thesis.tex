...
\begin{abstract}  % Abstract
    ...
    as well as a transport-triggered bus that exploits the data forwarding mechanism in the compact datapath.
    In addition, a novel scheduling algorithm that leverages the compact design to achieve both high throughput and flexible computation is presented.
